...
var verifyAccountAction        = require('../actions/RequestActions').verifyAccount;
...
class VerifyAccount extends React.Component {
  ...
  _onSubmit(e) {
    ...
    if ('' !== email) {
      verifyAccountAction(email).then(function (res) {
        this.setState({
          message:      res,
    ...
    return (
      <section className="login-div">
        <div className="col-lg-4 col-lg-offset-4 login-box">
          ...
          <p className="login-subtitle">Verify your email address to check all your Clouds, Servers, Devices and Apps.</p>
          <form className="login-form" onSubmit={this._onSubmit}>
            ...
            <button className="col-xs-12 login-button" type="submit" onClick={this._onSubmit}>Verify account</button>
          </form>
        </div>
      </section>
    );
