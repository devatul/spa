...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    for (key in publicCloud) {
      ...
      } else if ('running' == publicCloud[key].status) {
      ...
      if ('pending-acceptation' == monitoringStatus) {
        ...
        if (undefined !== publicCloud[key].instance) {
      ...
      if ('pending-acceptation' == managementStatus) {
        ...
        management = (
          <span className="action-button nubity-green" onClick={this._warning.bind(this, managementStart, publicCloud[key], publicCloud[key])}>Start</span>
        );
      } else if ('accepted' == managementStatus) {
        management = (
          <span className="action-button nubity-red" onClick={this._warning.bind(this, managementStop, publicCloud[key], managementCode)}>Stop</span>
        );
      ...
      if ('running' == publicCloud[key].status) {
        actionButtons = (
          <td className="icons hidden-xs hidden-sm">
            ...
            <span className="icon nb-stop action-icon" onClick={this._warning.bind(this, 'stop', publicCloud[key], publicCloud[key])}></span>
            <span className="icon nb-restart action-icon" onClick={this._warning.bind(this, 'restart', publicCloud[key], publicCloud[key])}></span>
          </td>
        );
      } else if ('stopped' == publicCloud[key].status) {
        actionButtons = (
          <td className="icons hidden-xs hidden-sm">
            <span className="icon nb-start action-icon " onClick={this._warning.bind(this, 'start', publicCloud[key], publicCloud[key])} ></span>
