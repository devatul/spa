    ...
    return (
      <div className={SessionStore.isLoggedIn() ? 'log-in-margin' : ''}>
        <div className="section-title">
          <h2 className={SessionStore.isLoggedIn() ? 'align-center logged-in-title' : 'align-center logged-out-title'}>Terms and conditions</h2>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-xs-10 col-md-8">
              ...
              <ul>
                ...
                <li className="polices-text">You must be a human. Accounts registered by "bots" or other automated methods are not permitted.</li>
                <li className="polices-text">
