    ...
    for (var key in onPremise) {
      ...
      switch (this.state.modalType) {
        ...
        case 'monitoringStart':
          ...
          notice = (
            <span>
              You are activating management services for device {onPremise[key].hostname}.<br/>
          ...
          confirmButtons = (
            <div className="pull-right">
              ...
              <span className="action-button nubity-green" onClick={this._managed.bind(this, onPremise[key])}>I Accept</span>
            </div>
          );
        break;
        case 'monitoringStop':
